...
export default function NavBar() {
    return (
        <header className="bg-red-600">
            <div className="container mx-auto flex justify-between position:fixed">
                <nav className="flex">
                    <NavLink to="/" exact
                ...
                <div className="inline-flex py-3 px-3 my-6">
                    <SocialIcon
                        url="https://www.instagram.com/ebenezerolushola1/"
                        className="mr-4 target=_blank" fgColor="#fff" style={{ height: 35, width: 35 }} />
                    <SocialIcon
                        url="https://web.facebook.com/ebenezer.olushola"
                        className="mr-4 target=_blank" fgColor="#fff" style={{ height: 35, width: 35 }} />
                    <SocialIcon
                        url="https://www.linkedin.com/in/ebenezer-akinde-04a48019b/"
                        className="mr-4 target=_blank" fgColor="#fff" style={{ height: 35, width: 35 }} />
                </div>
            </div>
        </header>
